...
class LoginTest(unittest.TestCase):
    ...
    def test_complete_order(self):
        ...
        # Go to Checkout Completed
        chkoutOverview.click_fns()

        # Checkout Completed Page
        complete = CheckoutCompletedPage(driver)
        # Verify Completed Order
        self.assertTrue(complete.verify_complete_message(), "THANK YOU FOR YOUR ORDER")
